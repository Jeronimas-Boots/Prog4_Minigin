...
void dae::Minigin::RunOneFrame()
{
	...
	const auto sleepTime = frameStartTime + std::chrono::duration_cast<std::chrono::milliseconds>(std::chrono::duration<float, std::milli>(m_MsPerFrame)) - std::chrono::high_resolution_clock::now();
